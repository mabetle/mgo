...
var (
	logger = mlog.GetLogger("github.com/mabetle/mgo/mcore/mconf/yaml")
)

type YamlConfig struct {
}

func (c YamlConfig) Put(k, v string) {
...
func (c YamlConfig) GetStringWithDefault(key, dv string) string {
	return ""
}
